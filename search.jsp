...
<%
    String distributorBalance = "0.00";
    int distributorId = 1; // Replace with actual distributor ID retrieval logic
    ...
    try {
        ...
        String sql = "SELECT Balance FROM Distributors WHERE DistributorID = ?";
        pstmt = conn.prepareStatement(sql);
        pstmt.setInt(1, distributorId);
        rs = pstmt.executeQuery();
        if (rs.next()) {
            distributorBalance = rs.getString("Balance");
        }
    } catch (Exception e) {
        e.printStackTrace();
    } finally {
...
<div class="top-bar">
    ...
    <span class="balance">Balance: ₹<%= distributorBalance %></span>
...
<div class="main-content">
    <div class="left-navigation">
        <button onclick="window.location.href='dashboard.jsp'"><img src="iconnn.png" alt="">Dashboard</button><br><br>
        ...
        <button onclick="window.location.href='modify.jsp'"><img src="icons8.gif" alt="">Modify</button><br><br>
        <button onclick="window.location.href='pay.jsp'"><img src="icon11.png" alt="">Pay</button><br><br>
        ...
        <button><img src="icon001.png" alt="">Reports</button><br>
    </div>
    <div class="notification">
        <%
            ...
            if (query != null && !query.trim().isEmpty()) {
                try {
                    conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cable", "root", "tiger");
                    String sql = "SELECT * FROM Customers2 WHERE FirstName LIKE ? OR LastName LIKE ? OR Phone LIKE ? OR BoxID LIKE ?";
                    pstmt = conn.prepareStatement(sql);
                    ...
                    out.println("<tr><th>CustomerID</th><th>FirstName</th><th>LastName</th><th>Phone</th><th>BoxID</th><th>Status</th><th>Renew</th><th>Order</th></tr>");
                    while (rs.next()) {
                        out.println("<tr>");
